...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        pc <- widgetToPageContent $ do
            ...
            addScript $ StaticR js_jquery_3_6_3_js
    ...
    isAuthorized FillR _ = isAuthenticated
    isAuthorized (DeleteR _) _ = isAuthenticated
    isAuthorized (CompareR _ _) _ = isAuthenticated
    isAuthorized SearchUserR _ = isAuthenticated
    isAuthorized CurUserR _ = isAuthenticated
    isAuthorized AllMediaR _ = isAuthenticated
